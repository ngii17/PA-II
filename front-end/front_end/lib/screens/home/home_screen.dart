          ...
          children: [
            Container(
              ...
              child: Column(children: [
                Container(
                  ...
                  child: Icon(Icons.local_offer_rounded, color: accent, size: 40),
                ),
                ...
                if (promo['tgl_mulai'] != null && promo['tgl_selesai'] != null) ...[
                  const SizedBox(height: 6),
                  Text(
                    "${promo['tgl_mulai']} s/d ${promo['tgl_selesai']}",
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                Text(
                  kategori == 'semua'
                      ? "Berlaku untuk Hotel & Restoran!"
                      : "Berlaku untuk layanan ${kategori[0].toUpperCase()}${kategori.substring(1)}!",
                  textAlign: TextAlign.center,
                ...
                if (kodePromo != null) ...[
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.confirmation_number_outlined, color: accent, size: 18),
                  ...
                  const SizedBox(height: 6),
                  const Text(
                    "Gunakan kode di atas saat checkout",
