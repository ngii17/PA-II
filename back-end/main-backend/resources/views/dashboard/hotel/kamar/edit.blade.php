...
.header-nomor-badge {
    ...
    font-weight: 800;
    letter-spacing: .5px;
    box-shadow: 0 6px 16px rgba(0,25,125,.22);
    margin-top: 10px;
}
...
<div class="edit-page-wrapper">
    ...
    <div class="edit-header">
        <h2 class="fw-800">Edit <span>Unit Kamar</span></h2>
        <p>Perbarui informasi dan status ketersediaan kamar.</p>
        <div class="header-nomor-badge">
            <i class="fas fa-door-open"></i> Kamar {{ $kamar->nomor_kamar }}
        </div>
    </div>
    ...
    <div class="form-card">
        <div class="form-card-header">
            <h5><i class="fas fa-edit"></i> Form Edit Kamar</h5>
        ...
        <div class="form-card-body">
            <form action="{{ route('dashboard.hotel.kamar.update', $kamar->id) }}" method="POST">
                                ...
                                >
                                    @foreach($tipeKamar as $tipe)
                                        <option value="{{ $tipe->id }}"
                                            {{ old('tipe_kamar_id', $kamar->tipe_kamar_id) == $tipe->id ? 'selected' : '' }}>
                ...
                <!-- SECTION: Status -->
                <div class="form-section-label" style="margin-top: 8px;">Status Ketersediaan</div>
                ...
                <div class="field-group">
                    ...
                    <div class="status-picker">
                        ...
                        @php
                            $isChecked = old('status_kamar_id', $kamar->status_kamar_id) == $status->id;
